...
class ServerBridge(object):
    ...
    def _post_with_apikey(self, path):
        ...
        response = urequests.post(self.base_url + path, headers=headers)
        return response
    ...
    def get(self, path, **kwargs):
        ...
        response = urequests.get(self.base_url + path, headers=headers, **kwargs)
        return response

    def get_with_url(self, url, **kwargs):
        headers = self._prepare_headers(self._token_header)
        response = urequests.get(url, headers=headers, **kwargs)
        return response
    ...
    def post(self, path, data, **kwargs):
        ...
        response = urequests.post(self.base_url + path, data=data, headers=headers, **kwargs)
        return response
    ...
    def delete(self, path, **kwargs):
        headers = self._prepare_headers(self._token_header)
        response = urequests.delete(self.base_url + path, headers=headers, **kwargs)
        return response
